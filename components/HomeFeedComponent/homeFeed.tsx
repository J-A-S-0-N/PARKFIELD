    ...
    setPostData([
      {
        ...
        SubTitle:
          "React Hooks 시작하기: Hooks는 React의 강력한 추가 기능으로, 클래스 없이 상태 및 다른 React 기능을 사용할 수 있게 해줍니다. 이 가이드는 useState와 useEffect를 포함한 Hooks의 기본을 다루며, 이를 React 애플리케이션에 실용적인 예제와 모범 사례를 통해 어떻게 통합할 수 있는지 보여줍니다. Hooks는 상태 관리와 컴포넌트 간 로직 공유를 단순화하여, 코드를 더 깔끔하고 유지보수하기 쉽게 만듭니다.",
      ...
      },
      {
        ...
        SubTitle:
          "상태 관리 이해: Redux, Context API, React Query와 같은 도구를 사용하여 애플리케이션 상태를 효과적으로 처리하는 방법을 배워보세요. 전역 상태와 로컬 상태의 개념을 마스터하고, 성능 최적화와 유지 보수를 위한 전략을 발견하세요.",
          ...
          >
            ...
            <View style={styles.childPadding}>
              ...
              <View style={styles.prestatPadding}>
                <Text style={styles.subTitleTextStyle} numberOfLines={5}>
                  {item.SubTitle}
                </Text>
              </View>
